...
;(function (window) {
  ...
  class Promise {
    constructor(executor) {
      this.PromiseState = PENDING // Promise的状态属性
      this.PromiseResult = undefined // 保存结果数据
      this.callbacks = [] // 保存.then()和.catch()传进来的待执行的回调函数 结构: { onResolved: Function; onRejected: Function; }
